...
public class FoodInfo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView foodNametxt = (TextView)findViewById(R.id.foodNameText);
        TextView foodDatetxt = (TextView)findViewById(R.id.foodDateText);


        Intent in = getIntent();

        BitmapFactory.Options options = new BitmapFactory.Options();
        Bitmap originalBm = BitmapFactory.decodeFile(in.getStringExtra("foodImage"), options); //bitmap파일로 변경

        foodImageView.setImageBitmap(originalBm);
        foodNametxt.setText(in.getStringExtra("foodName"));
        foodDatetxt.setText(in.getStringExtra("foodDate"));


        /* ------------------------------------ 화면에 뛰우기 -------------------------------------------*/

        //수정 버튼
       /* Button foonUpdateBtn = (Button)findViewById(R.id.updateBtn);
        foonUpdateBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if(success) { //데이터가 db에 저장됬을 때(회원가입 성공했을 때)
                                ...
                                AlertDialog.Builder builder = new AlertDialog.Builder(FoodInfo.this);
                                builder.setMessage("등록 되엇습니다!").setPositiveButton("확인", new DialogInterface.OnClickListener() {

                                    @Override
                                    public void onClick(DialogInterface dialog, int which) {
                                        Log.e("test","test5");
                                        Intent intent = new Intent(FoodInfo.this, MainActivity.class);
                                        FoodInfo.this.startActivity(intent);
                                    }
                                });
                ...
                RequestQueue queue = Volley.newRequestQueue(FoodInfo.this);
...
*/
        ...
        cameraBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View v) {
                AlertDialog.Builder alertBuilder = new AlertDialog.Builder(FoodInfo.this);
                ...
                alertBuilder.setNeutralButton("취소", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        Toast.makeText(FoodInfo.this, "취소되었습니다.", Toast.LENGTH_SHORT).show();
                    }
                });
...
*/
    ...
    public void mOnClick(View v){
        ...
        switch (v.getId()){
            // 날짜선택 버튼이 클릭되면
            case R.id.databtn:
                new DatePickerDialog(FoodInfo.this, mDateSetListener, mYear,
                        mMonth, mDay).show();
