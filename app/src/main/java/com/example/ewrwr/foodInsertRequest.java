...
public class foodInsertRequest extends StringRequest {
    ...
    public foodInsertRequest(String foodName, String foodDate, String division, String category, String foodImage, String Email, Response.Listener<String> listener) { //생성자 호출
        super(Method.POST, URL, listener, null); //상속받은 StringRequest 의 생성자를 부른다. (어떤 방법으로 어디에, 에러시)
